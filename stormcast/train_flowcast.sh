#!/bin/bash
# Launch FlowCast (Conditional Flow Matching) training on Taiwan RWRF.
...
# --- Training parameters (FlowCast paper defaults) ---
batch_size=16
lr=5E-4
weight_decay=1E-4
...
# --- CFM parameters ---
sigma_path=0.01       # I-CFM probability-path std
t_eps=1.0E-5
sigma_data=0.5        # match the EDM teacher
time_scale=1000.0

# --- Validation sampling ---
valid_num_steps=10    # Euler steps for validation (FlowCast paper default)
solver='euler'
