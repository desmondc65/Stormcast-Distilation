#!/bin/bash
# Launch MeanFlow (average-velocity flow matching) training on Taiwan RWRF.
...
experiment_name="meanflow"
training_output_dir="$(pwd)/StormCast_meanflow"
run_id="0"
...
# --- Hybrid loss (per-channel β + optional log-PSD on qpepre) ---
