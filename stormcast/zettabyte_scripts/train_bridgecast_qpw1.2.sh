#!/bin/bash
# QPEPRE-WEIGHT ABLATION: qpepre channel weight = 1.2.
# Generated from train_bridgecast.sh by the qpepre-weight sweep generator.
...
# are inherited from the base train_bridgecast.sh — DO NOT edit those
...
experiment_name="bridgecast_qpw1.2_cleaned_4_27_2026"
training_output_dir="/data/exp_3_train_2_5_yrs_val_1yr_tp1/bridgecast_qpw_ablation/qpw1.2"
run_id="0"
...
# images came from.
channel_weights="[1.0,1.0,1.0,1.2]"
