#!/bin/bash
# QPEPRE-WEIGHT ABLATION (FlowCast): qpepre channel weight = 1.2.
...
experiment_name="flowcast_qpw1.2_cleaned_4_27_2026"
training_output_dir="/data/exp_3_train_2_5_yrs_val_1yr_tp1/flowcast_qpw_ablation/qpw1.2"
run_id="0"
