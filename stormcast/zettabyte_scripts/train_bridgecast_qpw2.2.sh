#!/bin/bash
# QPEPRE-WEIGHT ABLATION: qpepre channel weight = 2.2.
...
experiment_name="bridgecast_qpw2.2_cleaned_4_27_2026"
training_output_dir="/data/exp_3_train_2_5_yrs_val_1yr_tp1/bridgecast_qpw_ablation/qpw2.2"
run_id="0"
...
# images came from.
channel_weights="[1.0,1.0,1.0,2.2]"
