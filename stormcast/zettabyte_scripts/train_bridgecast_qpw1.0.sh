#!/bin/bash
# QPEPRE-WEIGHT ABLATION: qpepre channel weight = 1.0.
...
experiment_name="bridgecast_qpw1.0_cleaned_4_27_2026"
training_output_dir="/data/exp_3_train_2_5_yrs_val_1yr_tp1/bridgecast_qpw_ablation/qpw1.0"
run_id="0"
